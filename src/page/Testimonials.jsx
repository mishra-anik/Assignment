	...
	return (
		<div className='px-[2rem] mt-4'>
			...
			<div className='flex gap-10 mt-4 flex-wrap'>
				<card className='border p-4  flex flex-col gap-3 rounded-md w-full h-[12rem] lg:w-[60vw] '>
					<h1 className='text-xl text-blue-600 font-thin lg:text-2xl'>Sophia Carter</h1>
				...
				<card className='border p-4  flex flex-col gap-3 rounded-md w-full h-[12rem]  lg:w-[60vw]'>
					<h1 className='text-xl text-blue-600 font-thin'>Ethan Bennett</h1>
