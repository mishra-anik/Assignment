	...
	return (
		<>
			<div className=' navBar flex justify-between items-center p-4 bg-white-800 text-white lg:px-10'>
				...
				<button className='text-3xl font-thin text-black'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-menu-icon lucide-menu"><path d="M4 5h16"/><path d="M4 12h16"/><path d="M4 19h16"/></svg></button>
			</div>
			<Hero />
      ...
      <div className=' px-[2rem] py-4 bg-gray-800 text-white flex flex-col justify-center items-center'>
        ...
        <p className='text-sm'>&copy; 2025 ILETS Prep. All rights reserved.</p>
      </div>
      </footer>
		</>
	);
